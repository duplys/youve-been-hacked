...
<title>Hacking-Demos Beta - Installation</title>
</head>

<body class="beta">


<h1>Hacking-Demos Beta - Installation</h1>
...
/*
      Standard-Eintr&auml;ge erstellen
      
 */

if ($ok) {
	echo "<dt> Schritt 5: Begr&uuml;&szlig;ungstext anlegen, damit die DB nicht so leer ist... \n";
   ...
   if ($anlegen) {
      ...
      if (!mysql_query($query)) {
         // MySQL-Fehler
         echo "<dt> Fehler beim Anlegen des 1. Eintrags:<br> \n";        
         echo "MySQL-Fehler: ".mysql_errno().": ".mysql_error()." \n";
         $ok = false;
      } else {
         // Begruessungstext angelegt
         echo "<dd> Begr&uuml;&szlig;ungstext angelegt ..... OK!  \n";
      }
   }
}

if ($ok) {
	echo "<dt> Schritt 6: Den Autor und ersten Benutzer anlegen \n";
...
if ($ok) {
   ...
   echo "<br>Herzlichen Gl&uuml;ckwunsch: Die Hacking-Demo-Datenbank wurde erfolgreich eingerichtet!<br><br> \n";
