...
<html>
<head>
<title>Hacking-Demos - Unsichere Empfehlungsfunktion</title>
</head>

<body>

<h1>Hacking-Demos - Empfehlungsfunktion</h1>
...
<form action="empfehle.php" method="POST"> 
   ...
   <input type="text" name="to" value="<? echo $to; ?>" size="40">   <br>
   Ihre E-Mail-Adresse: <br> 
   <input type="text" name="from" value="<? echo $from; ?>" size="40">   <br><br>
